    ...
    <html>
        ...
        <body>
          ...
          <section class="container" style="margin-top: 80px;">
            <h1 class="text text-center" style="font-family: 'Aref Ruqaa', serif; font-size: 56px; margin-bottom: 80px; color: black;">معلومات الرواية</h1>
            <div class="row">
                <div class=" col-md-6  col-xs-12 col-sm-12 ">
                    <img src="{{ asset('img/'.$data->img) }}" style=" border-radius: 25px; border: 2px solid #868583; height: 400px; width: 300px; margin-bottom: 10px;" id="im">
                </div>


                <div class="col-md-6 col-xs-12 col-sm-12">
                    <h2 class="text text-center" style=" color: #f7bc22; margin-bottom: 55px; font-family: 'Aref Ruqaa', serif; font-size: 40px;">{{ $data->novel_name }}</h2>
                    ...
                    <hr>
                   <p class="text text-center"> <a href="{{ asset('pdf/'.$data->pdf) }}" class="btn11 btn btn-default" role="button">اضغط هنا لتحميل الكتاب</a></p>
        ...
        <section class="cont container" style="margin-top: 50px;margin-right: 50px;">
            <h2 class="text text-center" style="font-family: 'Aref Ruqaa', serif; font-size: 60px; margin-bottom:80px; ">روايات أخرى</h2>
           @foreach ($novels as $a)
            ...
            <div class=" row">
              <div class="col-xs-12 col-md-3 col-sm-6 " style="margin-right: 50px">
                  <div class="thumbnail">
                      <img src="{{ asset('img/'.$a->img) }}" style="height: 400px; border-radius: 0px;" alt="">
                      <div class="caption">
                        <h3 class="text text-center"style="font-family: 'Aref Ruqaa', serif; font-size:30px;color:  #f7bc22;">{{ $a->novel_name }}</h3>
                        <p class="text text-center"><a href="{{'../novel/'.$a->novel_id }}" style="color: #000;font-size: medium;" >اضغط هنا </a></p>
                      </div>
