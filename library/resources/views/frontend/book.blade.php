          ...
          <section class="container" style="margin-top: 80px;">
            ...
            <div class="row">
                <div class=" col-md-6  col-xs-12 col-sm-12 ">
                    <img src="{{ asset('img/'.$data->img) }}" style=" border-radius: 25px; border: 2px solid #f8e1a6; height: 400px; width: 300px; margin-bottom: 10px;" id="im">
                </div>


                <div class="col-md-6 col-xs-12 col-sm-12">
                    <h2 class="text text-center" style=" color: #f7bc22; margin-bottom: 55px; font-family: 'Aref Ruqaa', serif; font-size: 40px;">{{ $data->book_name }}</h2>
            ...
            <div class=" row">
              <div class="col-xs-12 col-md-3 col-sm-6 " style="margin-right: 50px;">
                  <div class="thumbnail">
                      ...
                      <div class="caption">
                        <h3 class="text text-center"style="font-family: 'Aref Ruqaa', serif; font-size:30px;color:  #f7bc22;">{{ $a->book_name }}</h3>
                        <p class="text text-center"><a href="{{'../book/'.$a->book_id }}"style="color: #000;font-size: medium;" >اضغط هنا </a></p>
                      </div>
                    </div>
