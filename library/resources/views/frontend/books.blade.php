                            ...
                            @foreach ($books as $a)
                              <div class=" col-md-4 col-sm-4 col-xs-12 "  >
                                  <div class="thumbnail" style="background:  none; border: none; box-shadow: none;">
                                      <img src="{{ asset('img/'.$a->img) }}" style="border-radius: 0px; height: 250px; width: 200px;" alt="">
                                      <div class="caption">
                                          <h3 class="text text-center" style="font-family: 'Aref Ruqaa', serif; font-size:30px ;    color: #bf9423;">{{ $a->book_name }}</h3>
                ...
                <div class="col-sm-4 col-md-4">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <a href="{{'book/'.$i->book_id }}"><h3> {{ $i->book_name }}</h3></a>

                     @if (Auth::check())
                     <div class="btn-group">
                        <button style="border-radius:30%;background-color: black">

                        <a href="{{URL::to('/book/destroy/'.$i->book_id)}} " style="color: red"  >Delete</a>
                           </button>

                          <button style="border-radius:30%;background-color: black">
                              <a href="{{URL::to('booksbackend/create')}}" >ADD</a>
                          </button>
                    </div>
