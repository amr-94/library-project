<!DOCTYPE html>
 ...
 <section class="container text text-center " style="margin-left:40px;margin-top: 40px; display: none; ;height: 300px;" id="contant">
                  ...
                  <!-- /.container-fluid -->
                    ...
                    <h1 style="text-align: center ; margin-bottom:50px;margin-top:50px;font-size:50px">قسم الروايات </h1>
                ...
                <div class="col-sm-4 col-md-4">
                  <div class="thumbnail">
                    ...
                    <div class="caption">
                      ...
                      <a href="{{'novel/'.$i->novel_id }}"><h3> {{ $i->novel_name }}</h3></a>
     @if (Auth::check())
                     <div class="btn-group">
                        <button style="border-radius:30%;background-color: black">

                        <a href="{{URL::to('/novel/destroy/'.$i->novel_id)}} " style="color: red"  >Delete</a>
                           </button>

                          <button style="border-radius:30%;background-color: black">
                              <a href="{{URL::to('novelsbackend/create')}}" >ADD</a>
                          </button>
                    </div>
