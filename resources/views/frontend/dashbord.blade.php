                    ...
                    <div class="thumbnail">
                        <div class="caption">
                            <h3
                                ...
                                اضافة مؤلف</h3>
                            <p class="text text-center"><a
                                    href="{{ route('authorsbackend.create') }}"style="color: #000;font-size: medium;">اضغط
                                    هنا </a></p>
                        </div>
                    </div>
                    ...
                    <div class="thumbnail">
                        <div class="caption">
                            <h3
                                ...
                                اضافة كتاب</h3>
                            <p class="text text-center"><a
                                    href="{{ route('booksbackend.create') }}"style="color: #000;font-size: medium;">اضغط
                                    هنا </a></p>
                        </div>
                    </div>
                    ...
                    <div class="thumbnail">
                        <div class="caption">
                            <h3
                                ...
                                اضافة رواية</h3>
                            <p class="text text-center"><a
                                    href="{{ route('novelsbackend.create') }}"style="color: #000;font-size: medium;">اضغط
                                    هنا </a></p>
                        </div>
                    </div>
        ...
        <footer class="container">
            <div class="row" style="margin-top: 30px;">
                ...
                <div class="col-md-6 col-md-push-4 col-sm-push-3 col-sm-9 col-xs-push-1 col-xs-11"
                    ...
                    <button type="submit"
                        style="width: 50px;  height: 42px; border: none; background-color: #383531; padding-top: 5px;"><span
                            class="glyphicon glyphicon-search" style="color: darkgoldenrod;"></span></button>
                    <input type="text"
                        style="width: 320px; padding: 13px 0px 9px 190px; border: none; background-color: #383531; color: darkgoldenrod;"
                        placeholder="تبحث عن كتاب معين">
                </div>
            </div>
