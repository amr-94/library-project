                                ...
                                <div class="thumbnail" style="background:  none; border: none; box-shadow: none;">
                                    ...
                                    <div class="caption">
                                        ...
                                        <p class="text text-center"><a href="{{ route('book.show', $a->id) }}"
                                                style="color: white; font-weight: bold;">اضغط هنا </a></p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    <div class="row">
        @foreach ($data as $i)
            <div class="col-sm-4 col-md-4">
                <div class="thumbnail">
                    <img src="{{ asset('filles/novels/image/' . $i->img) }}" alt="">

                    <div class="caption">

                        <a href="{{ route('novel.show', $i->id) }}">
                            <h3> {{ $i->novel_name }}</h3>
                        </a>
                        @if (Auth::check())
                            <div class="btn-group">
                                <button style="border-radius:30%;background-color: black">
                                    ...
                                    <a href="{{ route('novelsbackend.destroy', $i->id) }} "
                                        style="color: red">Delete</a>
                                </button>

                                <button style="border-radius:30%;background-color: black">
                                    <a href="{{ route('novelsbackend.create') }}">ADD</a>
                                </button>
                            </div>
                        @endif
                    </div>
