...
<body>
    ...
    <section class="container" style="margin-top: 80px;">
        <h1 class="text text-center"
            style="font-family: 'Aref Ruqaa', serif; font-size: 56px; margin-bottom: 80px; color: black;">معلومات الكتاب
        </h1>
        <div class="row">
            <div class=" col-md-6  col-xs-12 col-sm-12 ">
                <img src="{{ asset('filles/books/image/' . $data->img) }}"
                    style=" border-radius: 25px; border: 2px solid #f8e1a6; height: 400px; width: 300px; margin-bottom: 10px;"
                    id="im">
            </div>
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
                ...
                <hr>
                <p class="text text-center"> <a href="{{ asset('filles/books/pdf/' . $data->pdf) }}"
    ...
    <div class="" style="background-color:  #eceaea ;">
        <section class="cont container" style="margin-top: 50px;margin-right: 50px;">
            <h2 class="text text-center"
                style="font-family: 'Aref Ruqaa', serif; font-size: 60px; margin-bottom:80px; ">كتب أخرى</h2>
            @foreach ($books as $a)
                <div class=" row">
                        ...
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p class="text text-center"><a
                                        href="{{ route('book.show', $a->id) }}"style="color: #000;font-size: medium;">اضغط
                                        هنا </a></p>
                            </div>
                        </div>
